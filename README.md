...
CLI-утилита для быстрой генерации production-ready Kubernetes манифестов. Создает полноценные конфигурации для развертывания приложений в кластере Kubernetes с поддержкой современных DevOps практик.
